            ...
            <div class="col-lg-5 mb-4">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body" id="metasList">
                        <!-- Metas generadas dinámicamente -->
                        <ul class="list-group" id="listaMetas"></ul>
                    </div>
                </div>
            </div>

            <!-- 🟡 COLUMNA DERECHA – PUNTOS, RANKING, RECOMPENSAS -->
            <div class="col-lg-7">
    ...
    <script>
        ...
        async function completarMeta(id_usuario_tarea, descripcion) {
            ...
            try {
                ...
                alert("Error al validar la meta.");
            }
        }
        ...
        async function loadRecompensas() {
            try {
                // Este endpoint debe devolver: [ { id_recompensa, nombre, imagen_url, costo }, ... ]
